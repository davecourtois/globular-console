...
import { FileController } from "../controllers/File"; // File object already exist in js and I need to use it...
...
export class ImageViewer extends HTMLElement {
    ...
    shadowRoot.innerHTML = `
      ...
      <div id="imageViewer" class="modal" >
        ...
        <div class="container"  id="imageContainer">
          ...
          <div id='zoomBtns'>
            <iron-icon id='zoomInBtn' icon="icons:add"></iron-icon>
            <iron-icon id='zoomOutBtn' icon="icons:remove"></iron-icon>
          </div>
        </div>
      </div>`;
  ...
  loadImgFrom(ele) {
    ...
    for (var i = 0; i < el.length; i++) {
      ...
      src += "?application=" + Application.name;
