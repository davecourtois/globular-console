 ...
 */
export class Notification  implements IModel{
    private _id: string;
    ...
    constructor(mac?:string, sender?: string, type?:NotificationType, recipient?: string, text?: string, date?:Date){
        ...
        mac? this._mac = mac : this._mac = "";
        recipient? this._recipient = recipient: this._recipient = "";
        type? this._type = type: this._type = NotificationType.User;
        text? this._text = text: this._text = "";
        sender? this._sender = sender: this._sender = "";
    ...
    /**
     * 
     * @returns Return the class data in json format.
     */
    toString(): string {
    ...
    /**
     * Initialyse the model from json object.
     * @param obj The class data.
     */
    fromObject(obj: any): void {
        ...
        this._date = new Date(obj._date * 1000)
    }
